...
public class TestGraphBuilding {
    ...
    public void testClosest() {
        double lon = -122.2892;
        double lat = 37.8885;
//        System.out.println(graph.lon(graph.tree.closest(lon, lat)) + " " + graph.lat(graph.tree.closest(lon, lat)));
//        System.out.println(graph.lon(53042711L) + " " + graph.lat(53042711L));
...
//        System.out.println(graphSmall.lon(graphSmall.tree.closest(lon, lat)) + " " + graphSmall.lat(graphSmall.tree.closest(lon, lat)));
        System.out.println(graph.adjacent(2252623344L));
